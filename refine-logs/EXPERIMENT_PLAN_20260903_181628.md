...
|---|---|---|---|
| D01–D04 | E0 / C1–C3 tensor core | budget、CE、GRPO、OPD CPU oracle | COMPLETE（CPU） |
| D05–D12 | E0 / trust stack | verifier、data、evaluator、statistics、runtime、provenance、CPU preflight | PLANNED（CPU） |
